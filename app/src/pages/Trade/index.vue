  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        :key="address.id"
      >
        <span class="username" :clss="{ selected: address.isDefault == 1 }">{{
          address.consignee
        }}</span>
...
export default {
  ...
  computed: {
    ...
    // 提交订单最终选择的地址
    userDefaultAddress() {
      // Array.find() 查找数组当中符合条件的元素返回，为最终结果
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let { userDefaultAddress,msg,orderInfo } = this;
      let data = {
        consignee: userDefaultAddress.consignee, // 收件人名字
        consigneeTel: userDefaultAddress.phoneNum, // 手机号
        deliveryAddress: userDefaultAddress.fullAddress, // 地址
        paymentWay: "ONLINE", // 支付方式
        orderComment: msg || "", // 买家留言信息
        orderDetailList: orderInfo.detailArrayList, //购物清单
      };
      // 两个参，tradeNo
